            ...
            properties: {
                ...
                evaluate: async (stringTemplate) => { // remember this function can't use closures, it is passed to the worker as a string
                    ...
                    try { // try as math expression
                        ...
                        return result ? (result._data ? result._data : ((typeof(result.isOperatorNode)!=="undefined" || (result.units && result.toSI) || typeof(result.isConstantNode)!=="undefined") ? result.toString() : result)) : result;
                    } catch (e) {
